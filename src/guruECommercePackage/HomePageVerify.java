...
//	  driver.findElement(By.cssSelector("div.product-info div.actions   button[title=\"Add to Cart\"]")).click();
 	driver.findElement(By.xpath(".//*[@id='top']//li[./a[ @class='product-image'and contains(@title,'Xperia')]]/div[@class='product-info']/div[@class='actions']/button[@title='Add to Cart']")).click();
    ...
    driver.switchTo().window(handle);
 	 ...
 	 Thread.sleep(1000);
 	 driver.findElement(By.xpath(".//*[@id='shopping-cart-table']/tbody/tr[descendant::a[contains(@title,'Sony Xperia')]]/td[@class='product-cart-actions']/input")).clear();
...
public  void compareToPhoneUsingScrren() throws IOException, InterruptedException{
	driver.findElement(By.linkText("MOBILE")).click();
	//SONY XPERIA	 
 	driver.findElement(By.xpath(".//li[./a[contains(@href,'sony-xperia.html')]]//a[text()='Add to Compare']")).click();
	 System.out.println("statusMsgActual   FIRST ");

 	// IPHONE
 	driver.findElement(By.xpath(".//li[./a[contains(@href,'iphone.html')]]//a[text()='Add to Compare']")).click();
...
//	Thread.sleep(3000);
 	...
 	driver.findElement(By.xpath("//li[ @class ='item last' and ./a[contains(@href,'iphone.html')]]//a[text()='Add to Compare']")).click();
	String firstPhone = driver.findElement(By.cssSelector("div.product-info  a[title=\"IPhone\"]")).getText();
//	Thread.sleep(3000);

 	driver.findElement(By.xpath("//li[ @class ='item last' and ./a[contains(@href,'sony-xperia.html')]]//a[text()='Add to Compare']")).click();
...
public void wishList() throws Exception{
	...
	//		driver.findElement(By.xpath(" //li/a[@class='link-wishlist'] ")).click();
			...
			System.out.println("HI NEW XPATH checking");
			driver.findElement(By.xpath("//li[@class='item last'  and ./a[contains(@href,'lg-lcd.html')] ]//li/a[@class='link-wishlist'] ")).click();

		//	driver.findElement(By.xpath("//li[[@class='item last'] and [./a[contains(@href,'lg-lcd.html')]]]//li/a[@class='link-wishlist'] ")).click();
		}
			
		
		System.out.println("HI NEW XPATH checking......SUCCESS....");
 	...
 	String msgExp = driver.findElement(By.xpath(".//*[@id='top']//li[@class='success-msg']/ul/li/span")).getText();
...
public void purchaseProduct() throws InterruptedException{
	...
	if ( driver.findElements(By.xpath("//*[@id='wishlist-table']/tbody/tr/td[3]/div/div/input")).size()==0){
		...
		driver.findElement(By.linkText("TV")).click();
		 driver.findElement(By.xpath("//*[@id='top']//h2[@class='product-name']/a[contains(@href,'lg-lcd.html') and text()='LG LCD']")).click();
   ...
   //  	System.out.println("clear Qty ");
    ...
    //	System.out.println("enter Qty ");
     	...
     	//Clear CART
	 	String cnt = driver.findElement(By.xpath("/html/body/div/div/header/div/div[2]/div/div/a/span[3]")).getText();
     	System.out.println("clear Qty CART has "+cnt);
     	int cnts  =0;
     	Thread.sleep(3000);
     	if(!cnt.contentEquals(""))
     	   	 cnts  = Integer.parseInt(cnt);
     	while (cnts>0)
     	{
     //	if(cnts>1 )
     //	{ 
     		    cnt =driver.findElement(By.xpath("/html/body/div/div/header/div/div[2]/div/div/div/div[3]/div[1]/ul[@id='cart-sidebar']/li[1]/div/table/tbody/tr[2]/td/input")).getAttribute("value");
     		   cnts  = Integer.parseInt(cnt) -cnts;
     		     driver.findElement(By.xpath("//*[@id='header']/div/div[2]/div/div/a/span[2]")).click();
     	     	System.out.println("FIND Qty CART has "+cnt);

 	driver.findElement(By.xpath(".//*[@id='cart-sidebar']/li/div/a[2]")).click();
     	 for (String handle : driver.getWindowHandles()) {
 	    	driver.switchTo().window(handle);
 	 		}
     	driver.switchTo().alert().accept();
     	System.out.println("clearED>>> Qty ");
     	...
     	*/
     	...
     	if(driver.findElements(By.xpath("/html/body/div/div/header/div/div[2]/div/div/div/div[3]/p[1]/a")).size() !=0)
		{
     		//driver.findElements(By.xpath("/html/body/div/div/header/div/div[2]/div/div/div/div[3]/p[1]/a")).clear();
